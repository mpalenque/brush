...
REM ===== MONITOR 1 - Principal 1920x1080 (Screen 1) =====
echo Abriendo KIOSK en Monitor 1 (1920x1080)...
...
echo ========================================
echo.
echo Monitor 1 (1920x1080): http://192.168.1.100:3000/brush-reveal.html
